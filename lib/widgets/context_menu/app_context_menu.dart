...
///
/// When open, the [AppContextMenu] shows the child, or the widget returned
...
class AppContextMenu extends StatefulWidget {
  ...
  /// The widget that can be "opened" with the [AppContextMenu].
  ///
  /// When the [AppContextMenu] is long-pressed, the menu will open and
  ...
  /// doesn't size itself.
  ///
  /// When the [AppContextMenu] is "closed", this widget acts like a
...
class _DecoyChildState extends State<_DecoyChild>
    with TickerProviderStateMixin {
  static const Color _lightModeMaskColor = Color(0xFFFFFFFF);
      ...
      child: IntrinsicHeight(
        child: Container(
          ...
          decoration: BoxDecoration(
            color: AppColors.of(context).greyWhisper,
...
class AppContextMenuAction extends StatefulWidget {
  ...
  @override
  State<AppContextMenuAction> createState() => _AppContextMenuActionState();
}

class _AppContextMenuActionState extends State<AppContextMenuAction> {
  ...
  TextStyle get _textStyle {
    ...
    return AppTextStyles.body.copyWith(color: AppColors.of(context).black);
  }

  Color get _iconColor {
    if (widget.isDestructiveAction) {
      return AppColors.of(context).accentRed;
    }
            ...
            child: Container(
              decoration: BoxDecoration(
                color: _isPressed
                    ...
                    : AppColors.of(context).whiteSnow,
              ),
                  ...
                  children: <Widget>[
                    if (widget.leading != null)
                      Padding(
                        ...
                        child: Icon(widget.leading, color: _iconColor),
                      ),
                    Flexible(
                      child: widget.child,
                    ),
